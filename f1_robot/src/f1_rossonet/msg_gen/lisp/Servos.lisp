...
(cl:defmethod cl:initialize-instance :after ((m <Servos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Servos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1_rossonet-msg:<Servos> is deprecated: use f1_rossonet-msg:Servos instead.")))

(cl:ensure-generic-function 'link1-val :lambda-list '(m))
(cl:defmethod link1-val ((m <Servos>))
...
(cl:defmethod link2-val ((m <Servos>))
...
(cl:defmethod link3-val ((m <Servos>))
...
(cl:defmethod link4-val ((m <Servos>))
